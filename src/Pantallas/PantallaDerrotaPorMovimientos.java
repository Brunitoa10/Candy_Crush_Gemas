...
public class PantallaDerrotaPorMovimientos extends JPanel implements Pantalla {
    CentralPantallas miCentral;

    public PantallaDerrotaPorMovimientos(CentralPantallas mi_central) {
    ...
    public void agregarComponentes() {
	    ...
	    JLabel labelPerdiste2 = miCentral.crearLabel("Te quedaste sin movimientos", 30);
