...
public class Celda extends JLabel implements EntidadGrafica {
	 ...
	 * 
	 * public Celda(GUI ventana, EntidadLogica entidad_logica, int size_label,
	 * boolean visible) {
	 * super();
	 * 
	 ...
	 * {
	 * entidad_logica.set_EntidadGrafica_entidadInterna(new
	 * Celda(ventana,entidad_logica.get_gema_interna(), size_label, true));
	 * 
	 * System.out.println(entidad_logica.get_gema_interna().
	 * get_imagenes_representativas());
	 * }
	 * 
	 ...
	 * }
	 * 
	 * protected void fijar_imagen_escalada_para_celda(String path_imagen1, String
	 * path_imagen2) {
	...
	public Celda(VentanaAnimable ventana, EntidadLogica entidad_logica, int size_label, boolean visible) {
		...
		setBounds(ubicacion_eje_x, ubicacion_eje_y, ancho, alto);
		fijar_imagen_escalada_para_celda(entidad_logica.get_imagenes_representativas()[0]);
	}
