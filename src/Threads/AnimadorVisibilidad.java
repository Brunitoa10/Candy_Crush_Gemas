...
public class AnimadorVisibilidad extends Thread implements Animador {
	 ...
	 * 
	 * public AnimadorVisibilidad(CentralAnimaciones manager, Celda celda, int
	 * delay) {
	 ...
	 * ImageIcon icono_destello = new
	 * ImageIcon(this.getClass().getResource(path_imagen_destello));
	 * ImageIcon icono_imagen = new
	 * ImageIcon(this.getClass().getResource(path_imagen_estado));
	 * Image imagen_destello_escalada =
	 * icono_destello.getImage().getScaledInstance(size_label, size_label,
	...
	protected void animar_mostrar() {
		...
		Image imagen_destello_escalada = icono_destello.getImage().getScaledInstance(size_label, size_label,
				Image.SCALE_REPLICATE);
