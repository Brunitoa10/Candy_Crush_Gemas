...
public class EstrategiaMatchL implements Estrategias{
   ...
   public EstrategiaMatchL(int prioridad)
   {
    ...
    {
      return (primeraEntidadHorizontal.equals(ultimaEntidadVertical)) || (primeraEntidadHorizontal.equals(primeraEntidadVertical)) || (ultimaEntidadHorizontal.equals(ultimaEntidadVertical))||(ultimaEntidadHorizontal.equals(primeraEntidadVertical));
    }
