...
public class EstrategiaMatchL implements Estrategias {
  ...
  public EstrategiaMatchL() {
    this.prioridad = PrioridadEstrategias.PRIORIDAD_L;
  }
  ...
  private boolean cumpleLascondiciones(Entidad primeraEntidadHorizontal, Entidad ultimaEntidadHorizontal,
    ...
    return (primeraEntidadHorizontal.equals(ultimaEntidadVertical))
        ...
        || (ultimaEntidadHorizontal.equals(ultimaEntidadVertical))
        || (ultimaEntidadHorizontal.equals(primeraEntidadVertical));
  }
