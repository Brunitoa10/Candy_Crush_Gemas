...
public class EstrategiaMatchS implements Estrategias {
  ...
  public EstrategiaMatchS() {
    this.prioridad = PrioridadEstrategias.PRIORIDAD_S;
  }
  ...
  public Resultado se_Cumple_la_Estrategia(LinkedList<Entidad> horizontal, LinkedList<Entidad> vertical,
    ...
    if (cumpleLasDimensiones(tamañoHorizontal, tamañoVertical)
        && cumpleLascondiciones(horizontal.getFirst(), horizontal.getLast(), vertical.getFirst(), vertical.getLast())) {
  ...
  private boolean cumpleLascondiciones(Entidad primeraEntidadHorizontal, Entidad ultimaEntidadHorizontal,
      Entidad primeraEntidadVertical, Entidad ultimaEntidadVertical) {
    return !(primeraEntidadHorizontal.equals(ultimaEntidadVertical))
        && !(primeraEntidadHorizontal.equals(primeraEntidadVertical))
