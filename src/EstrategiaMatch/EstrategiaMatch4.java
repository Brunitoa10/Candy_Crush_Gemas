...
public class EstrategiaMatch4 implements Estrategias {
   ...
   public EstrategiaMatch4() {
      this.prioridad = PrioridadEstrategias.PRIORIDAD_4;
   }
   ...
   public Resultado se_Cumple_la_Estrategia(LinkedList<Entidad> horizontal, LinkedList<Entidad> vertical,
      ...
      if (tamañoHorizontal == 4 && tamañoVertical < 3) {
         ...
         Entidad gemaCreada = new GemaRayada(aux.get_TableroNotificable(), aux.get_fila(), aux.get_columna(),
               new Color(aux.get_color()), 5, false, aux.get_Skin());
         toReturn = new Resultado(horizontal, gemaCreada);
      } else if (tamañoVertical == 4 && tamañoHorizontal < 3) {
         Entidad aux = vertical.getFirst();
         Entidad gemaCreada = new GemaRayada(aux.get_TableroNotificable(), aux.get_fila(), aux.get_columna(),
               new Color(aux.get_color()), 1, false, aux.get_Skin());
         toReturn = new Resultado(horizontal, gemaCreada);
      }
      return toReturn;
   }
