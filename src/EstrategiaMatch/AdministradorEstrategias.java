...
public class AdministradorEstrategias {
	...
	private Resultado matchea(LinkedList<Entidad> caramelosEnFila, LinkedList<Entidad> caramelosEnColumna,
			Entidad entidad) {
		Resultado resultadoparcial = null;
		Resultado resultadoparcial2 = null;
		if (listas_Estrategias.getFirst().get_prioridad() == 1) {
			resultadoparcial = listas_Estrategias.getFirst().se_Cumple_la_Estrategia(caramelosEnFila,
					caramelosEnColumna, entidad);
			if (resultadoparcial != null) {
				...
				while (estrategias.hasNext() && resultadoparcial2 == null) {
					resultadoparcial2 = estrategias.next().se_Cumple_la_Estrategia(caramelosEnFila, caramelosEnColumna,
							entidad);
				}
			}
			...
			while (estrategias.hasNext() && resultadoparcial == null) {
				resultadoparcial = estrategias.next().se_Cumple_la_Estrategia(caramelosEnFila, caramelosEnColumna,
						entidad);
			}
		}
		if (resultadoparcial == null) {
